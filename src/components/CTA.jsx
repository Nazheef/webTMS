    ...
    <section className="py-20 bg-gray-50             bg-gray-50 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-6                text-4xl font-bold text-gray-800 dark:text-white">Ready to Get <span className="text-yellow-500">Started?</span></h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-8          dark:bg-cyan-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
            <div className="flex items-center mb-4">
              ...
              <p className="text-gray-700  text-gray-600 dark:text-white"><strong>Custom Pricing for Your Business</strong></p>
            </div>
            <p className="text-gray-600 text-sm     text-gray-600 dark:text-gray-300">
              We offer tailored pricing based on your specific needs, company size, and required modules. Contact us for a personalized quote that fits your budget and requirements.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: "Schedule a Demo", desc: "Book a personalized demonstration of our platform", action: "Schedule Now" },
              { title: "Chat with Sales", desc: "Get immediate answers to your questions", action: "Start Chat" },
              { title: "Get Pricing", desc: "Receive a customized quote for your business", action: "Request Quote" }
            ].map((item, i) => (
