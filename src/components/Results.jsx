  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-6      text-4xl font-bold text-gray-800 dark:text-white">Proven Results Across Industries</h2>
        <p className="text-center text-gray-600 mb-12     text-gray-600 dark:text-gray-300">Our clients consistently achieve remarkable improvements in their financial operations</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { value: "98%", label: "Client Satisfaction" },
            { value: "45%", label: "Time Savings" },
