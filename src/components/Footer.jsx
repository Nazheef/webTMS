      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{t.Financialmanagment }</p>
              </div>
            </div>
          ...
          <div>
            ...
            <li><a href="#" className="hover:text-yellow-500">{t.Home}</a></li>
              <li><a href={features}  className="hover:text-yellow-500">{t.Features}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.About}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.Contact}</a></li>
            </ul>
          </div>

          <div>
            <h3 className="font-bold mb-4">{t.OurServices}</h3>
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-yellow-500">{t.accounting}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.procurement}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.Disbursement}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.budgeting}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.financial}</a></li>
              <li><a href="#" className="hover:text-yellow-500">{t.compliance }</a></li>
            </ul>
          </div>

          <div>
            <h3 className="font-bold mb-4">{t.contactinfo}</h3>
