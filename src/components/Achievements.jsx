  ...
  const Achievements = ({t}) => {
    const achievements = [
      { number: "500+", label: t.label1, icon: "📈" },
      { number: "15+", label: t.label2, icon: "🌍" },
      { number: "50+", label: t.label3, icon: "👥" },
      { number: "24/7", label: t.label4, icon: "📞" }
    ];

    return (
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-gray-800 text-center mb-16     text-4xl font-bold text-gray-800 dark:text-white">
            {t.achievements .split(' ').map((word, i) =>
                  word === "Financial" ? (
