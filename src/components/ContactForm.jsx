      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-6 text-xl font-bold text-gray-800 dark:text-white">{t.contactForm}</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6 text-xl font-bold text-gray-800 dark:text-white" >{t.getInTouch}</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-gray-800 mb-2 text-xl font-bold text-gray-800 dark:text-white">{t.email}</h3>
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2 text-xl font-bold text-gray-800 dark:text-white">{t.call}</h3>
                  <div className="text-gray-600 text-sm">
                    <div className="flex items-center mb-1        text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2 text-xl font-bold text-gray-800 dark:text-white">{t.visit}</h3>
                  <div className="text-gray-600 text-sm">
                    <div className="flex items-center mb-1                 text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2 text-xl font-bold text-gray-800 dark:text-white">{t.BusinessHours}</h3>
                  <div className="text-gray-600 text-sm">
                    <div className="flex items-center mb-1             text-gray-600 dark:text-gray-300">
              ...
              <div className="mt-8 bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                <h3 className="font-bold text-gray-800 mb-2 ">{t.ReadytoTransform}</h3>
                ...
                <div className="text-xs text-gray-600 mt-2 flex justify-center">
                  <span className="flex items-center mr-4">✓ {t.Freeconsultation}</span>
                  <span className="flex items-center mr-4">✓{t.Noobligation}</span>
                  <span className="flex items-center">✓ {t.Customdemo}</span>
                </div>
              </div>
            </div>
          </div>
